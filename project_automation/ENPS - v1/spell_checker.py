...
def candidates(word):
    ...
    return (
        known([word])
        or known(similar_edit(word))
        or known(double_edit(word))
        or known(double_edit2(word))
        or known(double_back_edit(word))
        or known(double_back_edit2(word))
        or known(vowel_edit(word))
